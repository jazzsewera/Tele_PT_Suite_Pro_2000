 ...
 * @version 1.5 (2016-05-28) - fixed Cyfrowa wartoscCyfr... adjustment
 */
public class Amplituda {
    ...
    private double przedzialKwantyzacji;
    // Koniec pól klasy;
	...
	wartoscCyfrowejKwantyzacji = 0;
	przedzialKwantyzacji = maxAmplituda / 2047;
		
	while (wartoscCyfrowejKwantyzacji * przedzialKwantyzacji < amplitudaAbs && przedzialKwantyzacji != 0) {
	    // System.out.println(przedzialKwantyzacji);
	    // System.out.println(wartoscCyfrowejKwantyzacji);
	    wartoscCyfrowejKwantyzacji++;
	}
    }
	...
	double segmentowaPrzedzialKwantyzacji;
	...
	case 1:
	    ...
	    segmentowaPrzedzialKwantyzacji = (maxAmplituda/2) / 16;
	    while (amplitudaWzglKwantyzacji < amplitudaWzgl) {
		amplitudaWzglKwantyzacji += segmentowaPrzedzialKwantyzacji;
		wartoscKwantyzacji++;
	    }
	    break;
	case 2: {
	    amplitudaWzgl = amplitudaAbs-(maxAmplituda/4);
	    segmentowaPrzedzialKwantyzacji = (maxAmplituda/4) / 16;
	    while (amplitudaWzglKwantyzacji < amplitudaWzgl) {
		amplitudaWzglKwantyzacji += segmentowaPrzedzialKwantyzacji;
		wartoscKwantyzacji++;
	    }
	...
	case 3: {
	    ...
	    segmentowaPrzedzialKwantyzacji = (maxAmplituda/8) / 16;
	    while (amplitudaWzglKwantyzacji < amplitudaWzgl) {
		amplitudaWzglKwantyzacji += segmentowaPrzedzialKwantyzacji;
		wartoscKwantyzacji++;
	    }
	...
	case 4: {
	    ...
	    segmentowaPrzedzialKwantyzacji = (maxAmplituda/16) / 16;
	    while (amplitudaWzglKwantyzacji < amplitudaWzgl) {
		amplitudaWzglKwantyzacji += segmentowaPrzedzialKwantyzacji;
		wartoscKwantyzacji++;
	    }
	...
	case 5: {
	    ...
	    segmentowaPrzedzialKwantyzacji = (maxAmplituda/32) / 16;
	    while (amplitudaWzglKwantyzacji < amplitudaWzgl) {
		amplitudaWzglKwantyzacji += segmentowaPrzedzialKwantyzacji;
		wartoscKwantyzacji++;
	    }
	...
	case 6: {
	    ...
	    segmentowaPrzedzialKwantyzacji = (maxAmplituda/64) / 16;
	    while (amplitudaWzglKwantyzacji < amplitudaWzgl) {
		amplitudaWzglKwantyzacji += segmentowaPrzedzialKwantyzacji;
		wartoscKwantyzacji++;
	    }
	...
	case 7: {
	    ...
	    segmentowaPrzedzialKwantyzacji = (maxAmplituda/128) / 16;
	    while (amplitudaWzglKwantyzacji < amplitudaWzgl) {
		amplitudaWzglKwantyzacji += segmentowaPrzedzialKwantyzacji;
		wartoscKwantyzacji++;
	    }
